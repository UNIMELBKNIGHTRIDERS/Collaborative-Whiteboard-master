...
class ClientGUI extends JFrame{
  ...
  //  private final JSlider symetrySlider;
    ...
    public ClientGUI() {
        ...
        this.textToggle = new JToggleButton(new ImageIcon(((new ImageIcon("resources/stampicon.png")).getImage())
                .getScaledInstance(20,20, Image.SCALE_SMOOTH)));
        this.textToggle.setDisabledIcon(new ImageIcon(((new ImageIcon("resources/stampicon.png")).getImage())
        .getScaledInstance(20,20, Image.SCALE_SMOOTH)));
        this.textToggle.setPreferredSize(new Dimension(40,40));
        this.textToggle.setFocusPainted(false);
      this.eraseToggle = new JToggleButton(new ImageIcon(((new ImageIcon("resources/eraserIcon.png")).getImage())
       ...
       // this.symetrySlider = new JSlider(JSlider.HORIZONTAL, 1, 7, 1);
        ...
        this.strokeTypes = new StrokeType[12];
       ...
       this.strokeDropdown.setFocusable(false);
        ...
        this.open = new JMenuItem("Open",KeyEvent.VK_T);
    ...
    private void setSideBar() { 
     ...
     /*   symetrySlider.addChangeListener(new ChangeListener() {
        ...
        textToggle.addItemListener(new ItemListener() {
            @Override
            public void itemStateChanged(ItemEvent e) {
                if(textToggle.isSelected()){
                    textToggle.setEnabled(false);
                    setBrushToggles(false,false,true,false,false);
    ...
    private void setBrushToggles(boolean brush, boolean fill, boolean text, boolean eraser, boolean dropper) {
        brushToggle.setSelected(brush);
        cloneToggle.setSelected(text);
    ...
    private void buildMenuBar() {     
        ...
        this.open.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S,ActionEvent.CTRL_MASK));
